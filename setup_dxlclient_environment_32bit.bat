...
set SCRIPT_DIR=%cd%
set PYTHON_DIR=%cd%\python_32
if not exist %PYTHON_DIR% mkdir %PYTHON_DIR%

echo "Downloading 32-bit python ..."
powershell (New-Object System.Net.WebClient).DownloadFile('https://www.python.org/ftp/python/2.7.11/python-2.7.11.msi','C:\temp\python_32.msi')
start /wait msiexec /i C:\temp\python_32.msi  /qn TARGETDIR=%PYTHON_DIR% %INSTALL_OPTS%
if not %ERRORLEVEL%==0 (
